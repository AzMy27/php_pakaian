      ...
      <div class="col-md-8">
        ...
        <div class="card card-primary">
          ...
          <form
            id="tambahData"
            method="post"
            action="proses/kabkota/proses_tambah_kabkota.php"
          ...
          >
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="pusat_pemerintahan"
                  >Pusat Pemerintahan</label
                >
                <input
                  type="text"
              ...
              <div class="form-group">
                <label for="jumlah_kecamatan"
                  >Jumlah Kecamatan</label
                >
                <input
                  type="number"
              ...
              <div class="form-group">
                <label for="jumlah_kelurahan"
                  >Jumlah Kelurahan</label
                >
                <input
                  type="number"
              ...
              <div class="form-group">
                <label for="url_peta_wilayah"
                  >Link URL Peta Wilayah</label
                >
                <input
                  type="url"
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  name="deskripsi"
                >
                Masukan <em>beberapa</em> teks
                deskripsi <u>kabupaten/kota</u>
