    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <a
              href="index.php?page=tambah_kabkota"
              type="button"
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <a
                        href="index.php?page=ubah_kabkota&id=<?=$row['id'];?>"
                      ...
                      ></a>
                      <a
                        href="proses/kabkota/proses_hapus_kabkota.php?id=<?=$row['id'];?>"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container">
                                    ...
                                    <div class="col-sm-5 col-6"> <?= $row["jumlah_kecamatan"]; ?> m2</div>

                                    <div class="w-100 d-none d-md-block"></div>
                                    <div class="col-sm-5 col-6">Jumlah Kelurahan</div>
                                    <div class="col-sm-5 col-6"> <?= $row["jumlah_kelurahan"]; ?> m2</div>

                                    <div class="w-100 d-none d-md-block"></div>
                                    <div class="col-sm-5 col-6">Jumlah Desa</div>
                                    <div class="col-sm-5 col-6"> <?= $row["jumlah_desa"]; ?> m2</div>
                                    ...
                                    <div class="col-sm-5 col-6"> <?= $row["deskripsi"]; ?> m2</div>
                                </div>
                            </div>
                  <?php endforeach; ?>
                </tbody>
